...
7. Якщо перехід між БД можливий — переконатись, що доступ до перекладів ізольований через інтерфейс репозиторію (розділ 7.4), а не "розмазаний" по контролерах чи Domain.
